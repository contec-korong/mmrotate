_base_ = [
    '../_base_/datasets/geoai.py', '../_base_/schedules/schedule_1x.py',
...
train_pipeline = [
    dict(type='LoadImageFromFile', ext='npy'),
    dict(type='LoadAnnotations', with_bbox=True),
    dict(type='RResize', img_scale=(1024, 1024)),
    dict(type='Pad', size_divisor=32),
    dict(type='DefaultFormatBundle'),
    dict(type='Collect', keys=['img', 'gt_bboxes', 'gt_labels'], meta_keys=['filename', 'ori_filename', 'ori_shape', 'img_shape',
